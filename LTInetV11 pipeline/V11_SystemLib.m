...
% V11_SystemLib — single source of truth for all 7 base systems.
% Identical dynamics to V6_SystemLib.m — renamed only. System definitions
% are not a "feature," so nothing here was pruned for the V11 feature cut.
...
% ── 3. REPRESSILATOR (2-node reduction) ─────────────────────────────
...
% ── 7. GENETIC TOGGLE SWITCH (multi-fixed-point) ─────────────────────
...
S(7).ic_fun = @(p) [];   % filled in by caller (randomized basin choice)
